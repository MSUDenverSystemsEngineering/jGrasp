...
Try {
	...
	[string]$appVendor = 'jGrasp'
	[string]$appName = ''
	[string]$appVersion = '2.04'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\jgrasp204.exe" -Parameters "/quiet" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "C:\Program Files (x86)\jGRASP\uninstall.exe" -Parameters "/quiet"
